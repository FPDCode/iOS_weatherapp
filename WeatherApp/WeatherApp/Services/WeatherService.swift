...
actor WeatherService {
    ...
    func fetchWeather(latitude: Double, longitude: Double) async throws -> WeatherResponse {
        ...
        components.queryItems = [
            ...
            URLQueryItem(name: "minutely_15", value: "precipitation,rain,snowfall"),
            URLQueryItem(name: "hourly", value: "temperature_2m,apparent_temperature,precipitation_probability,precipitation,weather_code,surface_pressure,relative_humidity_2m,visibility,wind_speed_10m,wind_gusts_10m,wind_direction_10m,uv_index,dew_point_2m,cloud_cover,cloud_cover_low,cloud_cover_mid,cloud_cover_high,shortwave_radiation,cape,soil_temperature_0cm,soil_moisture_0_to_1cm"),
            URLQueryItem(name: "daily", value: "weather_code,temperature_2m_max,temperature_2m_min,precipitation_probability_max,sunrise,sunset,uv_index_max,wind_speed_10m_max,wind_gusts_10m_max,wind_direction_10m_dominant,sunshine_duration,daylight_duration,precipitation_sum,precipitation_hours"),
